...
public class DoubleSeekBar extends View {
    ...
    public DoubleSeekBar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        bgHeight = dp2px(context, 2);//设置背景线条的高度
        ...
        paddingLeft = dp2px(context, 16);
        paddingRight = dp2px(context, 16);

        paintBg.setColor(getResources().getColor(R.color.red));
        paintBg2.setColor(getResources().getColor(R.color.green));
        maxValue = 100;//default maxvalue
        minValue = 0;//default minvalue
        leftValue = minValue;
        rightValue = maxValue;

        defaultWidth = dp2px(context, 100);
        defaultHeight = dp2px(context, 50);
