...
public class MyElongScaleSeekBar extends View {
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            if (attr == R.styleable.MyElongScaleSeekBar_scale_progress_normal_color) {
    scaleProgressNormalColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_progress_section_color) {
    scaleProgressSectionColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_left_ball_bg_color) {
    scaleLeftBallBgColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_left_ball_stroke_color) {
    scaleLeftBallStrokeColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_left_ball_stroke_with) {
    scaleLeftBallStrokeWith = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_right_ball_bg_color) {
    scaleRightBallBgColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_right_ball_stroke_color) {
    scaleRightBallStrokeColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_right_ball_stroke_with) {
    scaleRightBallStrokeWith = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_ball_radio) {
    scaleBallRadio = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_seek_height) {
    scaleSeekHeight = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_left_text_color) {
    scaleLeftTextColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_left_text_size) {
    scaleLeftTextSize = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_right_text_color) {
    scaleRightTextColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_right_text_size) {
    scaleRightTextSize = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_text_margin_ball) {
    scaleTextMarginBall = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_progress_unit) {
    scaleProgressUnit = typedArray.getInteger(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_ball_shadow_color) {
    scaleBallShadowColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_ball_shadow_radio) {
    scaleBallShadowRadio = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_ball_stick_color) {
    scaleBallStickColor = typedArray.getColor(attr, Color.BLACK);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_ball_stick_height) {
    scaleBallStickHeight = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_ball_stick_width) {
    scaleBallStickWidth = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_ball_stick_margin) {
    scaleBallStickMargin = typedArray.getDimensionPixelOffset(attr, 0);
} else if (attr == R.styleable.MyElongScaleSeekBar_scale_symbol_front) {
